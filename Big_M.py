...
# # Define the problem
# c = np.array([5,-2,3])  # Objective function coefficients
# A = np.array([[2,1,-3], [-1,2,4], [3,-2,-1], [1,1,1]])  # Constraint coefficients
# b = np.array([10,8,6,-5])  # RHS of constraints
# constraints_type = ['<=', '<=', '=', '>=']  # Constraint types
# isMax = 1  # 0 for minimization, 1 for maximization
# variables_types =np.array(["Unrestricted","Non-negative","Unrestricted"])
